...
:build_share
	...
	call %MVN_EXEC% clean package -pl r2eln-share,r2eln-share-docker
EXIT /B 0
:build_acs
    docker-compose -f "%COMPOSE_FILE_PATH%" kill r2eln-acs
    docker-compose -f "%COMPOSE_FILE_PATH%" rm -f r2eln-acs
	call %MVN_EXEC% clean package -pl r2eln-integration-tests,r2eln-platform,r2eln-platform-docker
EXIT /B 0
:tail
...
EXIT /B 0
:prepare-test
    call %MVN_EXEC% verify -DskipTests=true -pl r2eln-platform,r2eln-integration-tests,r2eln-platform-docker
EXIT /B 0
:test
    call %MVN_EXEC% verify -pl r2eln-platform,r2eln-integration-tests
EXIT /B 0
:purge
