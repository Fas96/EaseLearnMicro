...
public class WorkflowInstancesGet extends AbstractWorkflowWebscript
{
    ...
    public static final String PARAM_WORKFLOW_TYPE = "wfType";
...
//    private WorkflowInstanceDueAscComparator workflowComparator = new WorkflowInstanceDueAscComparator();
    private WorkflowInstanceEndDateComparator workflowComparator = new WorkflowInstanceEndDateComparator();
    ...
    protected Map<String, Object> buildModel(WorkflowModelBuilder modelBuilder, WebScriptRequest req, Status status, Cache cache)
    {
        ...
        if (req.getParameter(PARAM_WORKFLOW_TYPE) != null)
            filters.put(R2elnWorkflowModel.PROP_WORKFLOW_TYPE, req.getParameter(PARAM_WORKFLOW_TYPE));
        
        if (req.getParameter(PARAM_CONTENT_ID) != null)
            filters.put(R2elnWorkflowModel.PORP_CONTENT_ID, req.getParameter(PARAM_CONTENT_ID));
        ...
        else
        {
            ...
            workflows.addAll(workflowService.getWorkflows(workflowInstanceQuery, 500, skipCount));
        ...
        for (WorkflowInstance workflow : workflows)
        {
        	...
        	WorkflowUtils.appendCustomProp(workflowService, personService, nodeService, modelBuilder, model, workflow);
            results.set(skipCount, model);
    ...
    /**
     * Comparator to sort workflow instances by End date in descending order.
     */
    class WorkflowInstanceEndDateComparator implements Comparator<WorkflowInstance>
    {
        @Override
        public int compare(WorkflowInstance o1, WorkflowInstance o2)
        {
