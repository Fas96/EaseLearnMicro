...
public class KafkaConsumerConfig {
    ...
    private JsonDeserializer jsonDeserializer() {
        ...
        jsonDeserializer.addTrustedPackages("com.*");
        return jsonDeserializer;
    }

    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String,Message>> kafkaListenerContainerFactory(){
        ConcurrentKafkaListenerContainerFactory<String,Message> cklc=   new ConcurrentKafkaListenerContainerFactory<String,Message>();
